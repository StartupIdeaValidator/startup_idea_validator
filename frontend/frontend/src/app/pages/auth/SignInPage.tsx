...
export default function SignInPage({ onGoLanding, onGoSignUp, onSuccess }: SignInPageProps) {
    ...
    <AuthShell onGoLanding={onGoLanding}>
      <div className="rounded-2xl p-8" style={{ background: "#14141a", border: "1px solid rgba(255,255,255,0.08)" }}>
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-[#8888a0]">Sign in to continue validating your ideas</p>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <button className="text-xs text-[#4f6ef7] hover:text-[#7a9bff] transition-colors">Forgot password?</button>
            </div>
          ...
          <Checkbox checked={remember} onChange={setRemember}>Remember me for 30 days</Checkbox>
        </div>
        ...
        <p className="text-center text-sm text-[#8888a0] mt-6">
          ...
          <button onClick={onGoSignUp} className="text-[#4f6ef7] hover:text-[#7a9bff] font-medium transition-colors">Sign Up</button>
        </p>
      </div>
    </AuthShell>
  );
